...
namespace UIFramework
{
    ...
    public class UIFrame : MonoBehaviour
    {
        ...
        public virtual void Initialize()
        {
            ...
            m_PanelLayer.ScreenDestroyed += ScreenDestroyed;
            ...
            m_WindowLayer.ScreenDestroyed += ScreenDestroyed;
        ...
        public void OpenUi(BaseScreen screen, ScreenInfo screenInfo, BaseScreenData screenData)
        {
            ...
            layer.ShowScreen(screen, screenData);
        ...
        public void CloseUi(BaseScreen screen)
        {
            ...
            {
                m_PanelLayer.CloseScreen(screen);
            }
            else if (m_WindowLayer.IsExistScreens(screen))
            {
                m_WindowLayer.CloseScreen(screen);
            }
        }
        ...
        public BaseScreen FindScreenByScreenInfo(ScreenInfo screenInfo)
        {
            LayerProperties layerProperties;
            m_LayerPropertiesMap.TryGetValue(screenInfo.LayerId, out layerProperties);
